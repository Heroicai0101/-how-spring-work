...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
	...
	public Object applyBeanPostProcessorsBeforeInitialization(Object existingBean, String beanName)
		...
		for (BeanPostProcessor processor : getBeanPostProcessors()) {
			// @Resource 注解也是这个类解析？
			// @PostConstruct CommonAnnotationBeanPostProcessor extends InitDestroyAnnotationBeanPostProcessor
			// CommonAnnotationBeanPostProcessor 的构造函数声明了要处理的注解
	...
	protected BeanWrapper createBeanInstance(String beanName, RootBeanDefinition mbd, Object[] args) {
		...
		// 采用无参构造方法实例化对象，最终就是调用 BeanUtils.instantiateClass(无参构造方法, null)
	...
	protected Constructor<?>[] determineConstructorsFromBeanPostProcessors(Class<?> beanClass, String beanName)
		...
		if (beanClass != null && hasInstantiationAwareBeanPostProcessors()) {
			// 这里有七个BPP： CommonAnnotationBPP、AutowiredAnnotationBPP、RequiredAnnotationBPP
			for (BeanPostProcessor bp : getBeanPostProcessors()) {
				if (bp instanceof SmartInstantiationAwareBeanPostProcessor) {
					SmartInstantiationAwareBeanPostProcessor ibp = (SmartInstantiationAwareBeanPostProcessor) bp;
			...
			if (hasInstAwareBpps) {
				for (BeanPostProcessor bp : getBeanPostProcessors()) {
					if (bp instanceof InstantiationAwareBeanPostProcessor) {
						...
						// 这里执行了属性注入： @Resource注解 CommonAnnotationBeanPostProcess
	...
	protected Object initializeBean(final String beanName, final Object bean, RootBeanDefinition mbd) {
		...
		try {
			// 自定义的初始化方法： @Bean的init方法、 afterPropertiesSet()方法
